...
const headCells = [
  ...
  { id: 'category', numeric: true, disablePadding: false, label: '카테고리' },
  { id: 'writer', numeric: true, disablePadding: false, label: '작성자' },
...
export default function EnhancedTable() {
  ...
  const [state] = useAsync(() => api.getScrap(window.localStorage.getItem("user")), [window.localStorage.getItem("user")]);
  ...
  async function cancelScrap(value){
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none" onClick={event => window.location.href=`detail?id=${row.id}`}>
                        {row.title}
                      </TableCell>
                      <TableCell align="right">{row.category}</TableCell>
                      <TableCell align="right">{row.writerName}</TableCell>
                      <TableCell align="right"><Button
                        className={classes.button}
                        variant="contained"
                        color="inherit"
                        onClick={() => cancelScrap(row.id)}
                        >
                        스크랩 취소
                    </Button></TableCell>
                    </TableRow>
